...
//            out.println("</html>");
            ...
            if (res.getStatus() == Response.Status.OK.getStatusCode()) {
                String s= res.readEntity(String.class); //int rs = res.readEntity(int.class);
                //Integer s=res.readEntity(Integer.class);
                out.println("success.."+s+"...response status="+res.getStatus());
                //response.sendRedirect("dit2a03/pract8a/testForm.jsp?status="+s);
            } else {
                out.println(" failed ");
                //response.sendRedirect("dit2a03/pract8a/testForm.jsp?status="+res.getStatus());
            }
        }
    }
